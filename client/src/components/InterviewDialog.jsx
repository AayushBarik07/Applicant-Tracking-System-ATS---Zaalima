...
const InterviewDialog = ({ open, onClose, application, jobId }) => {
  ...
  const inviteMutation = useMutation({
    mutationFn: async () => {
      ...
      await axios.post(
        `${import.meta.env.VITE_API_URL || (import.meta.env.VITE_BASE_URL || '${import.meta.env.VITE_BASE_URL || 'http://localhost:5000'}') + '/api'}/applications/${application._id}/interview`, 
        { date, time, message },
