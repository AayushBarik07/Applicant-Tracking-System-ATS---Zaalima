...
const fetchJobs = async () => {
  const { data } = await axios.get((import.meta.env.VITE_API_URL || '${import.meta.env.VITE_API_URL || (import.meta.env.VITE_BASE_URL || '${import.meta.env.VITE_BASE_URL || 'http://localhost:5000'}') + '/api'}') + '/jobs');
  return data;
};
